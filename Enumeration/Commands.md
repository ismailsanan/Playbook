...
runas /netonly /user:DOMAIN.FQDN\USER "cmd.exe /c nltest /dclist:DOMAIN.FQDN"#check credentials

Invoke-Runas #powershell 

#spawns a shell on different domain using windows remote service 
winrs -r:dcorp-adminsrv cmd

#spanws a shell on different domain
...
Get-Service | ?{$_.DisplayName -like "*Apache*"}
